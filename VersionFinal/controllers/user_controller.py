...
def obtener_usuarios():
    ...
    return render_template("user/usuarios.html", usuarios=usuarios, fecha=fecha)
...
def saludar_usuario(nombre):
    ...
    return render_template("user/saludo.html", mensaje=mensaje)  # Muestra el mensaje en la vista
